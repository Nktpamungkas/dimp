...
<div class="col-sm-3">
    <table class="table table-bordered">
        ...
        <tr>
            <th><?php echo anchor('users','Masuk',array('class'=>'btn btn-danger'));?></th>
        </tr>
    </table>
</div>
<?php } elseif ($level==2) { ?>
<div class="col-sm-4">
    <table class="table table-bordered">
        ...
        <tr>
            <th><?php echo anchor('dimp','Masuk',array('class'=>'btn btn-danger'));?></th>
        </tr>
    </table>
</div>
<div class="col-sm-4">
...
<div class="col-sm-4">
    <table class="table table-bordered">
        ...
        <tr>
            <th><a href="<?= base_url('kartu_riwayat'); ?>" class="btn btn-danger">MASUK</a></th>
        </tr>
    </table>
</div>
<div class="col-sm-4">
    <table class="table table-bordered">
        ...
        <tr>
            <th><a href="<?= base_url('kartu_riwayat/index_NOW'); ?>" class="btn btn-primary">MASUK</a></th>
        </tr>
    </table>
</div>
<div class="col-sm-4">
    <table class="table table-bordered">
        ...
        <tr>
            <th><a href="<?= base_url('kartu_riwayat/pemakaian_spare_parts'); ?>" class="btn btn-success">MASUK</a></th>
        </tr>
    </table>
</div>
<div class="col-sm-4">
    <table class="table table-bordered">
        ...
        <tr>
            <th><a href="<?= base_url('kartu_riwayat/kartu_stock'); ?>" class="btn btn-success">MASUK</a></th>
        </tr>
    </table>
</div>
<div class="col-sm-4">
    <table class="table table-bordered">
        ...
        <tr>
            <th><a href="<?= base_url('kartu_riwayat/laporan_open_tiket'); ?>" class="btn btn-success">MASUK</a></th>
        </tr>
    </table>
</div>
<div class="col-sm-4">
    <table class="table table-bordered">
        ...
        <tr>
            <th><a href="<?= base_url('kartu_riwayat/kartu_stock_bydate'); ?>" class="btn btn-success">MASUK</a></th>
        </tr>
    </table>
</div>
<?php } ?>