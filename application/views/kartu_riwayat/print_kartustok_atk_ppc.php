<?php
    ...
    $query_barang  = "SELECT * FROM tbl_master_barang_atk_ppc where id='$id_barang' LIMIT 1";
    ...
    AND TRANSACTIONDATE > '2025-04-29'";
    ...
    $query_data = "SELECT t.*,a.VALUESTRING as KETERANGAN
        ...
        AND t.LOGICALWAREHOUSECODE ='M415'
