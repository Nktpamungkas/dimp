<?php
    ...
    $query_barang  = "SELECT * FROM tbl_master_barang_atk_dye where id='$id_barang' LIMIT 1";
    ...
    AND TRANSACTIONDATE > '2025-04-16'";
    ...
    $query_data = "SELECT t.*,a.VALUESTRING as KETERANGAN
        ...
        AND t.LOGICALWAREHOUSECODE ='M406'
        ...
        AND t.TRANSACTIONDATE > '2025-04-16'
    ...
    if (empty($data)) {
        $data[] = [
            ...
            'nama'                 => '',
            'paraf'                => '',
            'keterangan'           => 'Balance per 16 April 2025',
        ];
    }
...
<head>
    ...
    <title>Kartu Stok ATK | DYE</title>
    <style>
        body {
