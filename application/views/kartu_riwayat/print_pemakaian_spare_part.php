...
<body>
    <?php if($InternalDocument == 'InternalDocument') : ?>
        <table width="100%" border="0" class="table-list1">
            <thead>
                <tr>
                    <td width="10%" align="center"><img src="<?= base_url('assets/images/logoitti.png'); ?>" width="40" height="40"></td>
                    <td width="60%" align="center" valign="center"><h2><br>FORM PEMAKAIAN SPARE PART DIT</h2></td>
                    <td width="30%">
                        <div align="left"><pre>No. Form &Tab; : &Tab;FW-19-DIT-07</pre></div>
                        <div align="left"><pre>No. Revisi &Tab; : &Tab;00</pre></div>
                        <div align="left"><pre>Tgl Terbit &Tab; : &Tab;06 April 2015</pre></div>
                    </td>
                </tr>
            <thead>
        </table>
        ...
        <table width="100%" border="0" class="table-list1">
            <thead>
                <tr style="font-weight: bold;">
                    ...
                    <td style="width:30%"><div align="center">Kode Barang</div></td>
                    <td style="width:50%"><div align="center">Nama Spare Part</div></td>
                    <td style="width:15%"><div align="center">Jumlah</div></td>
                </tr>
            </thead>
            <tbody>
                <?php 
            ...
            <thead>
                <tr>
                    <td align="left" colspan="3">
                        ...
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style='font-size:20px;'>&#9634;</span> Pinjam
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td align="left" colspan="3">
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style='font-size:20px;'>&#9634;</span> Tukar / Ganti dengan Kode / Nama Barang : 
                    </td>
                </tr>
                <tr>
                    <td align="left" colspan="3">
    ...
    <?php else : ?>
        ...
        <table width="100%" border="0" style="font-family:sans-serif, Roman, serif; font-size:12px;">
            <thead>
                ...
                <tr>
                    <td align="left" colspan="3">
                        <b>Catatan : <?= $row_header['NO_BARCODE'] ?>, <?= $row_header['INTERNAL_DOC'] ?>, <?= $row_header['REMARKS'] ?></b>
                    </td>
                </tr>
            </thead>
        </table>
        <table width="100%" border="0" class="table-list1">
            <thead>
                ...
                <tr>
                    ...
                    <td align="center"><img width="40" alt='Barcode Generator TEC-IT' src='https://barcode.tec-it.com/barcode.ashx?data=<?= $row_header['NAMA_DIBUAT'] ?>&code=QRCode&translate-esc=on&eclevel=L'/></td>
                    <td align="center"><img width="40" alt='Barcode Generator TEC-IT' src='https://barcode.tec-it.com/barcode.ashx?data=<?= $row_header['NAMA_DITERIMA'] ?>&code=QRCode&translate-esc=on&eclevel=L'/></td>
                    <td align="center"><img width="40" alt='Barcode Generator TEC-IT' src='https://barcode.tec-it.com/barcode.ashx?data=<?= $row_header['NAMA_KEPALA_USER'] ?>&code=QRCode&translate-esc=on&eclevel=L'/></td>
                    <td align="center"><img width="40" alt='Barcode Generator TEC-IT' src='https://barcode.tec-it.com/barcode.ashx?data=<?= $row_header['NAMA_KEPALA_DIT'] ?>&code=QRCode&translate-esc=on&eclevel=L'/></td>
                </tr>
            </thead>
        </table>
    <?php endif; ?>
