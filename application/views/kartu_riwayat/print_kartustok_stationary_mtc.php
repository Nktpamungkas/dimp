<?php
    ...
    $query_barang  = "SELECT * FROM tbl_master_barang_stationary_mtc where id='$id_barang' LIMIT 1";
    ...
    $query_data = "SELECT t.*,a.VALUESTRING as KETERANGAN
        ...
        AND t.LOGICALWAREHOUSECODE ='M412'
...
<head>
    ...
    <title>Kartu Stok ATK | Stationary MTC</title>
    <style>
        body {
