...
<body>
    ...
    <table width="100%" border="1">
        ...
        ");
            ...
            ?>
            <?php $no = 1;
            while ($row_barang = db2_fetch_assoc($query_barang)) : ?>
                <tr>
                    ...
                    <td style="text-align: center;">
                        ...
                        if ($row_barang['NAMA_BARANG'] == 'Kabel LAN Cat. 5e Indoor' && $row_barang['KATEGORI'] == 'Sparepart' && $row_barang['KODE_BARANG'] == 'DIT-NETWK-LOC-CABLE5E---INDOOR-FT') {
                            ...
                            $row_barang['KATEGORI'] == 'Sparepart' && $row_barang['KODE_BARANG'] == 'DIT-PERIF-LOC-BATTERY---UPS' || $row_barang['KODE_BARANG'] == 'DIT-PERIF-LOC-KEYBOARD---USB'
