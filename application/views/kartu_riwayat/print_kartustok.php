...
<body>
    <table border="1" width="100%" style="border-collapse: collapse;">
        <tr>
            <td width="10%" align="center">
                <img src="<?= base_url(); ?>assets\images\ITTI_Logo Option_Logogram ITTI.png" width="70">
            </td>
    ...
    <table>
        ...
        <tr>
            ...
            ?>
            <td><?= number_format($row_min_stok['SAFETYSTOCK'], 0); ?></td>
        </tr>
        <tr>
            <td>Kelompok</td>
            <td>:</td>
    ...
    <table border="1" width="100%" style="border-collapse: collapse;">
        ...
        <tbody>
            ...
            <tr>
                <td align="center"><?= $row_stock_transaction['TGL']; ?></td> <!-- Tgl -->
                ...
                <td align="center"><?= $row_stock_transaction['ORDERCODE_TEMPLATE']; ?></td> <!-- Surat Jalan/Bon Pengambilan barang -->
