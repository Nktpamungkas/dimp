<?php
    ...
    $query_barang  = "SELECT * FROM tbl_master_barang_atk_ghs where id='$id_barang' LIMIT 1";
    ...
    AND TRANSACTIONDATE > '2025-05-16'";
    ...
    $query_data = "SELECT t.*,a.VALUESTRING as KETERANGAN
        ...
        AND t.LOGICALWAREHOUSECODE ='M427'
        ...
        AND t.TRANSACTIONDATE > '2025-05-16'
...
<head>
    ...
    <title>Kartu Stok ATK ghs</title>
    <style>
        body {
