...
<div class="push">
    <ol class="breadcrumb">
        ...
        <li><?= anchor("kartu_riwayat/$laporan", $title); ?> </li>
        <li class="active">Data</li>
    </ol>
</div>
<form method="post" enctype="multipart/form-data" target="_blank" action="<?= base_url("kartu_riwayat/$print"); ?>" class="form-horizontal">
<div class="row">
    <div class="col-xs-12">
        <div class="box">
            <div class="col-md-12">
                        ...
                        <select class="form-control js-example-basic-single" name="kode_barang">
                            ...
                            <?php
                                $query = "SELECT
                                            ...
                                            CONCAT_WS('-',
                                                TRIM(DECOSUBCODE01),
                                                TRIM(DECOSUBCODE02)) AS KODE_BARANG_NEW,
                                            id
                                        FROM $tabel_data ";
                                ...
                                while ($row = $result->fetch_assoc()){
                                    //Berdasarkan chat tidak perlu peritem, hanya semua saja
                                    break;
                                 ?>
                                        <option value="<?php echo $row['id']; ?>">
                                            (<?php echo htmlspecialchars($row['KODE_BARANG_NEW']); ?>)<?php echo htmlspecialchars($row['DESCRIPTION']); ?>
                                        </option>
                                    <?php }
                                        }
