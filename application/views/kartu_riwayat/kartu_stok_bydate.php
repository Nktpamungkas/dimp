...
<form method="post" enctype="multipart/form-data" target="_blank"
    action="<?= base_url('kartu_riwayat/print_kartustok_bydate'); ?>" class="form-horizontal">
    <div class="row">
        <div class="col-xs-12">
            <div class="box">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <select class="form-control js-example-basic-single" name="kode_barang">
                                ...
                                <option value="<?= $row_product_master['KODE_BARANG']; ?>">
                                    (<?= $row_product_master['KODE_BARANG']; ?>)
                                    <?= $row_product_master['LONGDESCRIPTION']; ?>
                                </option>
                                <?php endwhile; ?>
                            </select>
                        </div>
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <div class="col-sm-2">
                            <input style="text-align: center;" type="date" min="2024-01-10"
                                class="form-control input-sm" name="date1" autocomplete="off" required>
                        </div>
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <div class="col-sm-2">
                            <input style="text-align: center;" type="date" min="2024-01-10"
                                class="form-control input-sm" name="date2" autocomplete="off" required>
                        </div>
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="form-group">
                        <div class="col-sm-2">
                            <button type="submit" class="btn btn-primary btn-social btn-linkedin btn-sm" name="save"
