<?php
    ...
    $query_barang  = "SELECT * FROM tbl_master_barang_atk_csr where id='$id_barang' LIMIT 1";
    ...
    $query_data = "SELECT t.*,a.VALUESTRING as KETERANGAN
        ...
        AND t.LOGICALWAREHOUSECODE ='M422'
...
<head>
    ...
    <title>Kartu Stok ATK | CSR</title>
    <style>
        body {
