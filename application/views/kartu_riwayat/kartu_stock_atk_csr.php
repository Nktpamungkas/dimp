...
<div class="push">
    <ol class="breadcrumb">
        ...
        <li><?php echo anchor('kartu_riwayat/kartu_stock_atk_csr', "Kartu Stok ATK & SUPPLIES CSR"); ?> </li>
        <li class="active">Data</li>
    </ol>
</div>
<form method="post" enctype="multipart/form-data" target="_blank" action="<?php echo base_url('kartu_riwayat/print_kartustok_atk_csr'); ?>" class="form-horizontal">
<div class="row">
    <div class="col-xs-12">
        <div class="box">
            <div class="col-md-12">
                        ...
                        <select class="form-control js-example-basic-single" name="kode_barang">
                            ...
                            <?php
                                $query = "SELECT
                                            ...
                                            DESCRIPTION,
                                            id
                                        FROM tbl_master_barang_atk_csr ";
