    ...
    <table border="0" cellpadding="0" cellspacing="0" id="sheet0" class="sheet0 gridlines" width="100%">
        ...
        <tbody>
            ...
            <tr class="row3">
                ...
                <td class="column2 style1 null style1" colspan="2"><?= $row_breakdown_header['MESIN'] ?></td>
                <td class="column4 style31 s">Type</td>
                <td class="column5 style1 null style2" colspan="2"><?= $row_breakdown_header['TYPE'] ?></td>
            </tr>
            <tr class="row4">
                <td class="column0 style32 s style33" colspan="2">No. Mesin</td>
                <td class="column2 style3 null style3" colspan="2"><?= $row_breakdown_header['NO_MESIN'] ?></td>
                <td class="column4 style34 s">Document</td>
                <td class="column5 style3 null style4" colspan="2"><?= $row_breakdown_header['DOCUMENT'] ?></td>
            </tr>
            <tr class="row5">
