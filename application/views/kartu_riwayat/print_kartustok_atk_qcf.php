<?php
    ...
    $query_barang  = "SELECT * FROM tbl_master_barang_atk_qcf where id='$id_barang' LIMIT 1";
    ...
    $query_data = "SELECT t.*,a.VALUESTRING as KETERANGAN
        ...
        AND t.WAREHOUSELOCATIONCODE ='001'
...
<head>
    ...
    <title>Kartu Stok ATK | QCF</title>
    <style>
        body {
