<?php
    ...
    $query_barang  = "SELECT * FROM tbl_master_barang_atk_gas where id='$id_barang' LIMIT 1";
    ...
    AND TIMESTAMP(TRANSACTIONDATE, TRANSACTIONTIME) > '2025-05-16 10:00:00'";
    ...
    $query_data = "SELECT t.*,a.VALUESTRING as KETERANGAN
        ...
        AND t.LOGICALWAREHOUSECODE ='M424'
        ...
        AND TIMESTAMP(t.TRANSACTIONDATE, t.TRANSACTIONTIME) > '2025-05-16 10:00:00'
    ...
    if (empty($data)) {
        $data[] = [
            ...
            'nama'                 => '',
            'paraf'                => '',
            'keterangan'           => 'Balance per 16 Mei 2025',
        ];
    }
...
<head>
    ...
    <title>Kartu Stok ATK gas</title>
    <style>
        body {
