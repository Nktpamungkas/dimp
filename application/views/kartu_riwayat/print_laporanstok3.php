                            ...
                            <table width="95%" style="border:1px solid black; border-collapse:collapse;">
                                <thead>
                                    <tr class="tombol">
                                        ...
                                        <th width="15%" style="border:1px solid black;">HARDWARE</th>
                                    </tr>
                                </thead>
                                <?php
                                    if($type == 'Semua'){
                                ...
                                <?php $no = 1; while ($row_opentiket = db2_fetch_assoc($q_opentiket)) : ?>
                                    <tbody>
                                        <tr>
                                            ...
                                            <td style="border:1px solid black;"><?= $row_opentiket['HARDWARE'] ?></td>
                                        </tr>
                                    </tbody>
                                <?php endwhile; ?>
                            </table>
                            ...
                            <?php
                                $q_kategori       = db2_exec($conn1, "SELECT
                                                                        ...
                                                                        WHERE
                                                                            $where_kategori
                                                                            AND SUBSTR(p.CREATIONDATETIME, 1, 10) BETWEEN '$date1' AND '$date2'
                                                                            AND NOT p2.FIRSTUSERGRPCODE IS NULL
                                                                        GROUP BY
                                                                            p2.FIRSTUSERGRPCODE");
                            ?>
                            <?php while ($row_kategori = db2_fetch_assoc($q_kategori)) : ?>
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <?= $row_kategori['HARDWARE']; ?> = <?= $row_kategori['JUMLAH_MASALAH']; ?> (<?= number_format($row_kategori['JUMLAH_MASALAH'] / $row_jumlah_masalah['JUMLAH_MASALAH'] * 100 , 2)?> %) <br>
                            <?php endwhile; ?>
                        </td>
                    </tr>
                </table>
